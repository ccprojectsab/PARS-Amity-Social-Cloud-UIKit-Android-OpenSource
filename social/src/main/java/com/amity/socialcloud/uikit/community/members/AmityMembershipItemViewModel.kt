            ...
            if (hasEditPermission && !isUserBanned(communityMembership)) {
                itemList.add(
                    AmityMenuItem(
                        ...
                        AmityLocalisation.getString(R.string.amity_promote_moderator)
                    )
                )
            }
                ...
                if (user.isFlaggedByMe()) {
                    itemList.add(
                        AmityMenuItem(
                            ...
                            AmityLocalisation.getString(R.string.amity_undo_report)
                        )
                    )
                } else {
                    itemList.add(
                        AmityMenuItem(
                            ...
                            AmityLocalisation.getString(R.string.amity_report)
                        )
                    )
                }
            }
            ...
            if (hasRemovePermission) {
                itemList.add(
                    AmityMenuItem(
                        ...
                        AmityLocalisation.getString(com.amity.socialcloud.uikit.common.R.string.amity_remove_from_community),
                        true
                    )
                )
            }
            ...
            if (hasEditPermission) {
                itemList.add(
                    AmityMenuItem(
                        ...
                        AmityLocalisation.getString(R.string.amity_remove_moderator)
                    )
                )
            }
