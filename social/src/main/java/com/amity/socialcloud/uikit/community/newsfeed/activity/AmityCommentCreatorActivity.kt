...
class AmityCommentCreatorActivity : AmityBaseToolbarFragmentContainerActivity() {
    ...
    override fun initToolbar() {
        ...
        if (replyTo != null) {
            getToolBar()?.setLeftString(AmityLocalisation.getString(R.string.amity_reply_to))
        } else {
            getToolBar()?.setLeftString(AmityLocalisation.getString(R.string.amity_add_comment))
        }
    }
