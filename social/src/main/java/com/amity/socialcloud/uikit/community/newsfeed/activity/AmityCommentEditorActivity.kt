...
class AmityEditCommentActivity : AmityBaseToolbarFragmentContainerActivity() {
    ...
    override fun initToolbar() {
        ...
        if (isReply) {
            getToolBar()?.setLeftString(AmityLocalisationSocial.getString(R.string.amity_edit_reply))
        } else {
            getToolBar()?.setLeftString(AmityLocalisationSocial.getString(R.string.amity_edit_comment))
        }
    }
