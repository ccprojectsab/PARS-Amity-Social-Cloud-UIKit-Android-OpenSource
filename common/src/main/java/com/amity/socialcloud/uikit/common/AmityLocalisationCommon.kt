...
object AmityLocalisationCommon {
    ...
    fun getString(@StringRes stringResId: Int): String {
        return stringsMap[stringResId]?.let { LocalizationManager.getString(it) }
            ?: applicationContext?.getString(stringResId) ?: "Unknown String"
    }
    ...
    private val stringsMap: Map<Int, String> = mapOf(
        ...
        R.string.amity_month_single to "social.general.time.months",
        R.string.amity_month_plural to "social.general.time.monthsPlural",
        
        R.string.amity_week_single to "social.general.time.weeks",
        R.string.amity_week_plural to "social.general.time.weeksPlural",
        
        R.string.amity_day_single to "social.general.time.days",
        R.string.amity_day_plural to "social.general.time.daysPlural",
        
        R.string.amity_hour_single to "social.general.time.hours",
        R.string.amity_hour_plural to "social.general.time.hoursPlural",
        
        R.string.amity_min_single to "social.general.time.minutes",
        R.string.amity_min_plural to "social.general.time.minutesPlural",

        // Remove old plural mappings since we now use individual strings
        /*
